    ...
    <main className="min-h-screen bg-[#f3efef] px-6 py-12">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <div className="flex gap-3">
          ...
          <Link
            href="/"
            className="inline-flex items-center justify-cente"use client";
...
}r rounded-full border border-[#c9bcad] bg-white px-6 py-3 text-sm font-medium text-[#0d0b09] transition hover:opacity-90"
          >
            Back to start
          </Link>
        </div>
